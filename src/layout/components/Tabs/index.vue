<template>
    <div class="tabs-container">
        <div class="tabs-item">
            <el-tabs v-model="activeTabName" :class="tabsStyleClass" @tab-click="tabClick" @tabRemove="tabRemove">
                <el-tab-pane v-for="tab in store.tabsStore.visitedViews" :key="tab" :label="tab.title" :name="tab.path"
                    :closable="!isAffix(tab)"></el-tab-pane>
            </el-tabs>
        </div>
        <el-dropdown class="tabs-action" trigger="click" placement="bottom-end" @command="onClose">
            <template #dropdown>
                <el-dropdown-menu>
                    ...
                    <el-dropdown-item :icon="CircleClose" command="closeOthers">关闭其他
                    </el-dropdown-item>
                    <el-dropdown-item :icon="CircleCloseFilled" command="closeAll">关闭全部
                    </el-dropdown-item>
                </el-dropdown-menu>
            </template>
            <el-icon>
